...
def create_focal_loss(type, device):
    if type == "BCEFocalLoss":
        criterion = BCEFocalLoss().to(device)
        return criterion
    elif type == "CEFocalLoss":
        criterion = CEFocalLoss(class_num=2).to(device)
        return criterion


register_criterion("BCEFocalLoss", create_focal_loss)
register_criterion("CEFocalLoss", create_focal_loss)